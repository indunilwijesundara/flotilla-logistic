...
<head>
    ...
    <title><?php echo $language["Register"]; ?> | Flotilla Logistic- Admin & Dashboard Template</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Get your Flotilla Logistic account now.</p>
                                </div>
                                <form class="needs-validation custom-form mt-4 pt-2"
                                    action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">

                                    <div
                                        class="form-floating form-floating-custom mb-4 <?php echo (!empty($useremail_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div
                                        class="form-floating form-floating-custom mb-4 <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div
                                        class="form-floating form-floating-custom mb-4 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div
                                        class="form-floating form-floating-custom mb-4 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0">By registering you agree to the Dason <a href="#"
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Already have an account ? <a href="login.php"
